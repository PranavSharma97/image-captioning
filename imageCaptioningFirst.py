...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  6 01:17:35 2018
...
def correct_spellings(descriptions):
    for key in descriptions:
        for desc in descriptions[key]:
            index = descriptions[key].index(desc)
            desc = re.sub(r"\bt-shirt\b", 'tshirt', desc)
            desc = re.sub(r"\bt-shirts\b", 'tshirts', desc)
            desc = re.sub(r"\bafrican-american\b", 'africanamerican', desc)
            desc = re.sub(r"\bmerry-go-round\b", 'merrygoround', desc)
            desc = re.sub(r"\bblader\b", 'rollerblader', desc)
            desc = re.sub(r"\bsnow-covered\b", 'snowcovered', desc)
            descriptions[key][index] = desc
            
correct_spellings(descriptions)
...
# changed = list()
# for key in descriptions.keys():
#     for d1, d2 in zip(desc2[key], descriptions[key]):
#         cur = list()
#         if d1 != d2:
#             cur.append(d1)
#             cur.append(d2)
...
# filt_dict = dict()
# filt_dict['t-shirt'] = 0
# filt_dict['t-shirts'] = 0
# filt_dict['merry-go-round'] = 0
# filt_dict['african-american'] = 0
# filt_dict['blader'] = 0
# filt_dict['snow-covered'] = 0
# for el in changed:
#     if 't-shirt' in el[1].split():
#         filt_dict['t-shirt'] += el[1].split().count('t-shirt')
#     if 't-shirts' in el[1].split():
#         filt_dict['t-shirts'] += el[1].split().count('t-shirts')
#     if 'snow-covered' in el[1].split():
#         filt_dict['snow-covered'] += el[1].split().count('snow-covered')
#     if 'african-american' in el[1].split():
#         filt_dict['african-american'] += el[1].split().count('african-american')
#     if 'blader' in el[1].split():
#         filt_dict['blader'] += el[1].split().count('blader')
#     if 'merry-go-round' in el[1].split():
#         filt_dict['merry-go-round'] += el[1].split().count('merry-go-round')
# =============================================================================
