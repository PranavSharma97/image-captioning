...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 24 22:20:09 2018
...
K.set_value(trained_model.optimizer.lr, 0.001)

K.set_value(trained_model.optimizer.decay, 0.0)

trained_model.fit([X1train, c_initial, X2train], ytrain, epochs=7, verbose=2, batch_size=32)

trained_model.save('final_model2.h5')
